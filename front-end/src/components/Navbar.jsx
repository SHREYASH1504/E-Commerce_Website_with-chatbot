...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
     <Link to='/'><img src={assets.logo} className='width-36' alt="" /> </Link>

    <ul className='hidden sm:flex gap-5 text-sm text-gray-700'>
    
    <NavLink to = '/' className='flex flex-col items-center gap-1 group '>
    <p>HOME</p>
    <hr className='w-2/4 border-none h-[1.5px] bg-gray-700 hidden group-hover:block'></hr>
    </NavLink>
    ...
    <div className='flex items-center gap-6'>
        ...
        <Link to='/cart' className='relative'>
            ...
            <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center bg-black text-white aspect-square rounded-full text-[10px]'>{getCartCount()}</p>
        </Link>
